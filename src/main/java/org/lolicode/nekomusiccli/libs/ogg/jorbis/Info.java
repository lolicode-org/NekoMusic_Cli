...
package org.lolicode.nekomusiccli.libs.ogg.jorbis;

import org.lolicode.nekomusiccli.libs.ogg.jogg.*;
...
public class Info{
  ...
  public String toString(){
    return String.format("version:%d, channels:%d, rate:%d, "
        +"bitrate:%d,%d,%d", version, channels, rate, bitrate_upper,
